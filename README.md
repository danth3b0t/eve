...
M1 includes configuration handling, protected SQLite state, advisory locks, durable TCP allocations and a journaled local Git creation boundary. Safe application-file publication and CLI integration are next; M2–M5 remain pending.
